...
class _DashboardPageState extends State<DashboardPage> {
  ...
  Future<void> sendAttendanceData() async {
    ...
    if (_isSignOutButtonClicked &&(_signOutbase64Image == null || _signOutbase64Image!.isEmpty)) {
      ...
      _showAttendacneDialog("Failed", "Required selfie! please click a selfie", 0);
      return;
    }
    ...
    if (latitude == -1 || longitude == -1) {
      ...
      _showAttendacneDialog("Failed", "Location is mandatory for this action! Make sure location service is enabled", 0);
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if(responseData['success'] && _isSignInButtonClicked)_showAttendacneDialog("Success", "You have successfully entered!", 200);
        if(responseData['success'] && _isSignOutButtonClicked)_showAttendacneDialog("Success", "Bye bye, see you next time!", 200);
        else _showAttendacneDialog("Failed", "Attendance already recorded!", 0);
        setState(() {
        ...
        // Request failed
        _showAttendacneDialog("Failed", "Check your internet connection or login again!", 0);
